...
class HotelRoomEndpointsTest {
    ...
    void setUp() {
        ...
        hotelMockMvc = MockMvcBuilders.standaloneSetup(new HotelController(hotelService, roomService, dtoMapper))
                .setControllerAdvice(new GlobalExceptionHandler())
                .build();

        roomMockMvc = MockMvcBuilders.standaloneSetup(new RoomController(roomService, dtoMapper))
                .setControllerAdvice(new GlobalExceptionHandler())
                .build();
    }
