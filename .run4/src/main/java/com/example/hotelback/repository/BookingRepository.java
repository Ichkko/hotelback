...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    @Query("""
            ...
            join r.hotel h
            join h.owners o
            where b.id = :id and o.id = :ownerId
            """)
    boolean existsByIdAndHotelOwnerId(@Param("id") Long id, @Param("ownerId") Long ownerId);
    ...
    @Query("""
            ...
            where b.id = :id and receptionist.id = :receptionistId
            """)
    boolean existsByIdAndHotelReceptionistId(@Param("id") Long id, @Param("receptionistId") Long receptionistId);
